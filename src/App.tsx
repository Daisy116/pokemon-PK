          ...
          <Card className="mb-4 rounded-2xl">
            ...
            <CardContent>
              <div className="flex gap-2 mb-2">
                ...
                <p className="h-8 px-4 text-sm rounded-full  min-w-[80px]" onClick={handleLookup} disabled={loading || !enemyName.trim()}>{loading? "查詢中…":"查屬性"}</p>
                // <button class="h-8 px-2 text-sm rounded-full min-w-[80px]" disabled="" style="background-color: black;color: white;">查屬性</button>
              </div>
            </CardContent>
          </Card>
